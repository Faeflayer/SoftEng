...
```
### Результат.
![Меню](https://github.com/Faeflayer/SoftEng/blob/Tema_10/pics/1.png )
...
```
### Результат.
![Меню]( https://github.com/Faeflayer/SoftEng/blob/Tema_10/pics/2.png)
...
```
### Результат.
![Меню]( https://github.com/Faeflayer/SoftEng/blob/Tema_10/pics/3.png)
...
def check_name(name):
    if len(name) > 10:
        raise NVE('Длина больше 10 символов')
    else:
...
```
### Результат.
![Меню](https://github.com/Faeflayer/SoftEng/blob/Tema_10/pics/4.png )
...
```
### Результат.
![Меню](https://github.com/Faeflayer/SoftEng/blob/Tema_10/pics/5.png )
